    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('unit.create') }}" method="POST" enctype="multipart/form-data" class="form-horizontal p-t-20">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control" id="exampleInputuname3" placeholder="Unit Name" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="code" class="form-control" id="" placeholder="Unit Code" required>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <textarea type="text" name="description" class="form-control" id="exampleInputuname3" placeholder="Unit Description" required></textarea>
                            </div>
                        </div>
                    </div>
