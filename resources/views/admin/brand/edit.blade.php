    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal p-t-20">
                   ...
                   {{-- Essential for security --}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="name" value="{{ $brand->name }}" class="form-control" id="exampleInputuname3" placeholder="Brand Name" required>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <textarea type="text" name="description" class="form-control" id="exampleInputuname3" placeholder="Brand Description" required>{{ $brand->description }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img src="{{ asset($brand->image) }}" width="130" height="100" alt="Brand Image">
                        </div>
                    </div>
