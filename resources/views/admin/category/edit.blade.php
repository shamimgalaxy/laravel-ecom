    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal p-t-20">
                   ...
                   {{-- Essential for security --}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="name" value="{{ $category->name }}" class="form-control" id="exampleInputuname3" placeholder="Category Name" required>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <textarea type="text" name="description" class="form-control" id="exampleInputuname3" placeholder="Category Description" required>{{ $category->description }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img src="{{ asset($category->image) }}" width="130" height="100" alt="Category Image">
                        </div>
                    </div>
