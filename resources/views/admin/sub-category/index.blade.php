            ...
            <div class="card-body">
               ...
               @csrf 
                    ...
                    <div class="form-group row">
                        <label for="exampleInputuname3" class="col-sm-3 control-label">SubCategory Name</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-text"><i class="ti-user"></i></span>
                                <input type="text" name="name" class="form-control" id="" placeholder="Category Name" name="category_name" required>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <textarea type="text" name="description" class="form-control" id="" placeholder="Sub Category Description" required></textarea>
                            </div>
                        </div>
                    </div>
