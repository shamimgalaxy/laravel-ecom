...
<link rel="stylesheet" href="{{ asset('website/assets/css/bootstrap.min2.css')}}" />
<link rel="stylesheet" href="{{ asset('website/assets/css/fontawesome2.css')}}" />
<link rel="stylesheet" href="{{ asset('website/assets/css/style2.css')}}" />
<link rel="stylesheet" href="{{ asset('website/assets/css/xzoom.min2.css')}}" />
